...
const preCargarViajes = () => {
  ...
  listOfTrips.push(
    ...
    new Trip("Carga Rápida", "MN-1005", "2025-07-28", "2025-07-30", "MNO654", "Juan Ramírez", "Bucaramanga", "Ibagué", "Papelería", "Resmas y tintas", 2200000, 900000, 400000, 150000, 120000)
  );
...
console.log("Se cargaron los viajes de prueba:", listOfTrips.length);
